...
public class DavCalendar {
	 ...
	 */
	public android.content.ContentValues ContentValues = new ContentValues();
	...
	private boolean correctSyncID(String calendarUri) {
		...
		android.content.ContentValues mUpdateValues = new ContentValues();
	...
	private DavCalendar createNewAndroidCalendar(DavCalendar serverCalendar, int index, android.content.Context context) {
		...
		final android.content.ContentValues contentValues = new ContentValues();
